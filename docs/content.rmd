...
Je m'appelle Marius et je fait de l'économie ;)

# Objectives {.tabset .tabset-fade .tabset-pills}

Contraintes imposées: Une simulation des comportements “réels” des agents, modélisés par des algorithmes simples (PAS D’OPTIMISATION) et en évitant à tout prix des lois globales de marchés. Idéalement, comportements simples et on voit émerger qq chose.
