...
pop_1 = Pop(id_pop=1, goods=goods, needs=needs_1, population=20, income=10, employed=employ_1)
pop_2 = Pop(id_pop=2, goods=goods, needs=needs_2, population=6, income=20, employed=employ_2)
pop_3 = Pop(id_pop=3, goods=goods, needs=needs_3, population=1, income=60, employed=employ_3)
